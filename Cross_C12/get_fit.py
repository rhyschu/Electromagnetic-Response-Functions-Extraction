...
if __name__ == "__main__":
    ...
    if QE_shift == 0.0:
        with open(data_fit, "w") as response_file:
            response_file.write("Data:Z,A,E0,ThetaDeg,nu,cross,error,dataSet,Fit:ep,theta,nu_fit,Ex,W2,q2,sigtot,sigqe,sigie,sigmec,nuccstot,signonuc,ratio\n")
        for index, row in df.iterrows():
            ...
            with open(data_fit, "a") as response_file:
                response_file.write(f"{Z},{A},{E0},{ThetaDeg},{nu},{cross},{error},{dataSet},{ep},{theta},{nu_fit},{Ex},{W2},{q2},{sigtot},{sigqe},{sigie},{sigmec},{nuccstot},{signonuc},{ratio}\n")
    else:
        with open(data_fit, "w") as response_file:
