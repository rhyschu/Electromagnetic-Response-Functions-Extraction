...
c     & 0.71092E-02,0.78423E-01,0.29565E+00,0.62607E+00,-.13227E+00 /
     ...
     & 0.26555E+01,0.26555E+01,0.34117E+01,0.76660E+00,0.88000E-01,
     & 0.65674E-02,0.88000E-01,0.31976E-01,0.56458E-01,-.86596E-01,
...
c           if(q2.GT.0.3) nuccs = 0.0
        ...
        sigtot = sigtot + nuccstot
         ...
         if(ep.GT.0.01.AND.w2.LT.40.) then
            write(6,2000) ep,theta,nu,nu-nuel,w2,q2,sigtot,sigqe,sigie,
