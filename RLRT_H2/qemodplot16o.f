...
c     & 0.71092E-02,0.78423E-01,0.29565E+00,0.62607E+00,-.13227E+00 /
     & 0.95448E-01,0.11155E+02,0.14058E+00,0.69490E+01,0.78047E+00,
     & 0.55998E-01,0.20269E+01,0.20780E+01,0.70810E+00,-.41604E+01,
     & 0.99246E+00,0.98128E+00,0.10239E+01,0.99225E+00,0.10000E+01,
     & 0.10055E+01,0.97858E+00,0.10043E+01,0.99275E+00,0.99630E+00,
     & 0.10000E+01,0.99845E+00,0.10025E+01,0.10105E+01,0.10050E+01,
     & 0.78686E+00,0.00000E+00,-.10298E+01,0.91836E+00,0.20357E+01,
     & 0.19577E+01,0.19619E+01,0.28402E+01,0.50897E+00,0.08800E+00,
     & 0.11412E-01,0.08857E+00,0.40638E-01,0.75587E-01,-.45099E-01,
     & 0.21907E-01,0.78793E-01,0.29658E+00,0.47752E+00,-.42369E+00 /      
      ...
      do i=1,3000
        ...
        nuccstot = 0.0
        do k=2,13
           call nuccs16cs(Z,A,ev,epv,theta,k,nuccs)
c           if(q2.GT.0.3) nuccs = 0.0
        ...
        sigtot = sigtot + nuccstot
         ...
         if(ep.GT.0.05.AND.w2.LT.40.) then
            write(6,2000) ep,theta,nu,w2,q2,sigtot,sigqe,sigie,sigmec,
     &                  nuccstot,signonuc
         endif
