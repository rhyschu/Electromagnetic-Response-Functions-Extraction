...
c     & 0.36333E-01,0.75341E-01,0.27892E+00,0.15692E+00,0.10459E+00 /
     ...
     & 0.24416E+01,0.24499E+01,0.31154E+01,0.72998E+00,0.08800E+00,
     & 0.76502E-02,0.08800E+00,0.31429E-01,0.58780E-01,-.15059E+00,
     & 0.38790E-01,0.77051E-01,0.26795E+00,0.17673E+00,0.10451E-01 /
      ...
      ! read qv, nu from user input.
      ! read(5,*) qv
      ! read(5,*) nu
      ! Python script can run the program and enter values easily. 
      ! This is how I calculate the "Qvedges". For every line of electron scattering data, 
      ! I call this program to calculate a prediction of RL RT.
      ! There must be a better way of doing this. The Fortran interface is wierd, I'm still getting used to it.
      
      ! Prof. Christy uses dnu as the increment of nu in the following loop. 
      ! His code starts with nu=0.0 and run 3000 steps to get 3000 lines of prediction.
      ! Since I want to calculate prediction of specified nu, I'm just not using it.
      dnu = 0.0
      ...
      do
        ...
        ! q2, qv, nu, ex, w2 are closely related to each other by these equations:  
        q2 = qv*qv - nu*nu
        nuel = q2/2./(0.931494*A)
        w2 = mp*mp+2.0*mp*nu-q2
        xb = q2/2.0/mp/nu
        ex = nu-nuel
        ! This is why we can calculate them interchangably. I made different versions of this file: 
        ! response_qv_nu.f, response_qv_ex.f, response_qv_w2.f; response_q2_nu.f, response_q2_ex.f, response_q2_w2.f 
        ! Enter the kinematic values as name suggested, then you can get the corresponding prediction.
