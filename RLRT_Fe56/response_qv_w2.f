...
c     & 0.36333E-01,0.75341E-01,0.27892E+00,0.15692E+00,0.10459E+00 /
     ...
     & 0.38790E-01,0.77051E-01,0.26795E+00,0.17673E+00,0.10451E-01 /
      ...
      do
        read(unit,*,IOSTAT=io_status) i, qv, w2
        if (io_status /= 0) exit
...
!        if(RLIE.LE.1E-40) RLIE = 0.0
!        if(RTIE.LE.1E-40) RTIE = 0.0
!        if(RLTOT.LE.1E-40) RLTOT = 0.0
!        if(RTTOT.LE.1E-40) RTTOT = 0.0
...
c        write(6, 2000) i, qv, q2, ex, nu, RTTOT, RLTOT, RTQE, RLQE, RTIE, RLIE, RTE, RLE, RTNS, RLNS          
