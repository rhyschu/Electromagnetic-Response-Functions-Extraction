...
CCCC  11- GDR, 26-37 MeV (mean at 31.5?), 12 - ~15.1 MeV state                    CCCC
      ...
      Real*8 e1,Radius,a0,a1,alph,g0,h0,a2,a3,a4,a5,b,fflowq2
      integer state,IA,IZ
...
c     g4 = 1.9E-4*exp(-1.0*(q2f-4.25)**2/1.0/1.0)
        g4 = 0.0
        FF2 = q2f**3./(q2f**3.0+0.01)*(g1+g2+g3+g4)   !!! New fit from Feb 2023
...
c        g1 = 0.0029*exp(-1.0*(qf-1.49)**2/0.7/0.7)
        g1 = 0.0029*exp(-1.0*(qf-1.69)**2/0.80/0.80)         
        g2 = 0.0
        g3 = 0.0
        e1 = 0.0
        FF2 = g1+g2+g3+e1
